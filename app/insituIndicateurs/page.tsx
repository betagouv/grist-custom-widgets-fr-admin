...
import "./page.css";
import { mappingsIsReady } from "./utils";
  ...
  return currentStep === "loading" ? (
    ...
    currentStep === "menu" && (
      <div style={{ margin: "auto", maxWidth: "76em" }}>
        ...
        >
          <button className="secondary" onClick={handleSwitchModeButton}>
            {viewMode === "simple"
              ? "Mode multi-colonne"
        ...
        {viewMode === "multi" ? (
          ...
          <>
            <p>
              ...
              pour trouver l'indicateur qui vous intéresse, copiez son
              identifiant et collez le ci-dessous.
            </p>
            ...
            <div className="advice">
              <span className="text-to-copy">
                Nous vous conseillons d'ajouter une description à votre colonne
                pour ne pas perdre la trace de l'identifiant utilisé :
                <br />
            ...
            <div className="radio-button">
              ...
              <label>
                <input
                  ...
                  onChange={() =>
                    setWantIndicateurDetail(!wantIndicateurDetail)
                  }
                />
                Le décompte de l'indicateur (Ex: Nombre de villes concernées par
                le programme)
              </label>
              <label>
                <input
                ...
                />
                Le détail de l'indicateur (Ex : Liste des villes concernées par
                le programme)
              </label>
            </div>
            <div className="radio-button">
